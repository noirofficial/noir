...
enum AvailableCoinsType
{
    ...
    ONLY_1000 = 5, // find noirnode outputs including locked ones (use with caution)
...
//    CAmount GetNormalizedAnonymizedBalance() const;
    ...
    /* Staking */
    bool CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64_t nTime, int64_t nSearchInterval, CAmount& nFees, CMutableTransaction& tx, CKey& key);
