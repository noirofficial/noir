...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Noir Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Noir Core"
...
#define PACKAGE_BUGREPORT "https://github.com/noirofficial/noir/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Noir Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Noir Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "noir"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://noirofficial.org/"
