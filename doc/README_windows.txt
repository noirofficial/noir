...
Copyright (c) 2014 Zoin Developers
...
Setup
-----
Unpack the files into a directory and run zoin-qt.exe.

zoin is the original zoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of zoin transactions;
